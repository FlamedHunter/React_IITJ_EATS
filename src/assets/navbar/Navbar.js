            ...
            <div className='sidenavbarcontainer'>
                ...
                <ul>
                    <li>
                        <a href="/" className='sidenavbaritems'>
                            <div className='sidenavbaritemsiconbox'>
                                <svg className='sidenavbaritemsicon' xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-list-nested" viewBox="0 0 16 16">
                    ...
                    <li>
                        <a href="/" className='sidenavbaritems'>
                            <div className='sidenavbaritemsiconbox'>
                                <svg className='sidenavbaritemsicon' xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
                    ...
                    <li>
                        <a href="/" className='sidenavbaritems'>
                            <div className='sidenavbaritemsiconbox'>
                                <svg className='sidenavbaritemsicon' xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                    ...
                    <li>
                        <a href="/" className='sidenavbaritems'>
                            <div className='sidenavbaritemsiconbox'>
                                <svg className='sidenavbaritemsicon' xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
                    ...
                    <li>
                        <a href="/" className='sidenavbaritems'>
                            <div className='sidenavbaritemsiconbox'>
                                <svg className='sidenavbaritemsicon' xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-gear-fill" viewBox="0 0 16 16">
                    ...
                    <li>
                        <a href="/" className='sidenavbaritems'>
                            <div className='sidenavbaritemsiconbox'>
                                <svg className='sidenavbaritemsicon' xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-question-lg" viewBox="0 0 16 16">
                ...
                <button className='sidebarlogoutbutton'>
                    ...
                    <span className='sidebarlogoutbuttoniconbox'>
                        <svg xmlns="http://www.w3.org/2000/svg" className='sidebarlogoutbuttonicon' fill="currentColor" class="bi bi-arrow-bar-right" viewBox="0 0 16 16">
